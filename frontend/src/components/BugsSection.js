...
export default function BugsSection({ data }) {
  ...
  return (
    <div data-testid="bugs-section">
      ...
      {/* Filters */}
      <div className="filters-bar" data-testid="bugs-filters">
        <input
          className="search-input"
          placeholder="Buscar por título, archivo, descripción..."
          value={searchTerm}
